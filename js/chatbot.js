...
const faqData = [
  {
    ...
    answer: '営業時間は10:00〜20:00です（火曜日のみ10:00〜18:00）。店舗により異なる場合がございますので、詳しくは<a href="shop.html">店舗案内</a>をご覧ください。'
  },
  {
    keywords: ['定休日', '休み', 'お休み', '休業'],
    answer: '天六本店は年中無休です（年末年始を除く）。店舗により異なる場合がございますので、詳しくは<a href="shop.html">店舗案内</a>をご覧ください。'
  },
  {
    keywords: ['場所', '住所', 'アクセス', '行き方', '駅', '地図'],
    answer: '各店舗の住所・アクセスは<a href="shop.html">店舗案内ページ</a>をご覧ください。天六本店は大阪メトロ 天神橋筋六丁目駅すぐです。'
  },
  {
